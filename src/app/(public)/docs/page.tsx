...
const modules = [
  {
    ...
    audience: "Public",
    path: "/freelancers",
    desc: "The core of the platform. Browse AI-native freelancers by name, skill, or tag. Each builder profile shows their bio, hourly rate, tools they use (Cursor, Claude Code, Lovable, etc.), and tags for discoverability. Creators can edit or delete their own builder profiles.",
    features: [
  ...
  },
  {
    id: "directory",
    Icon: Briefcase,
    title: "Jewish AI Professionals Directory",
    audience: "Public",
    path: "/directory",
    desc: "A searchable public directory of Jewish AI professionals — operators, founders, researchers. Each entry has name, title, company, location, bio, expertise tags, LinkedIn, and website.",
    features: [
  ...
  },
  {
    ...
    audience: "Public",
    path: "/showcase",
    desc: "A Product Hunt-style community leaderboard where builders submit vibe-coded projects. The best projects float to the top via upvotes (deduplicated per user). Each project gets a rank badge, comments thread, and inline image/video preview.",
    features: [
  ...
  },
  {
    ...
    audience: "Optional on every gig",
    path: "/admin/gigs/new",
    desc: "Drop a Loom share link into your gig and it auto-embeds as a video walkthrough on both the admin detail page and the public application page. Applicants see exactly what you need before they apply.",
    features: [
