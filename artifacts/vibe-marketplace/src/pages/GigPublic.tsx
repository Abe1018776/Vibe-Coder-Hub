...
import { useGetGig, useCreateGigReply, useRequestUploadUrl, getListGigRepliesQueryKey, getGetGigQueryKey } from "@workspace/api-client-react";
...
export default function GigPublic() {
